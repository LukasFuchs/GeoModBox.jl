...
For more details on how this is implemented please see this [documentation](./docs/src/man/GESolution.md).
...
For more details on how this is used in the ```GeoModBox.jl``` see [here](./docs/src/man/GESolution.md).
