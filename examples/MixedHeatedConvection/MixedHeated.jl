...
p2 = heatmap(x.c,y.c,D.T',
    ...
    quiver!(p2,x.c2d[1:Pl.qinc:end,1:Pl.qinc:end],
            ...
            layout=(2,1),subplot=2)
if save_fig == 1
    savefig(k,string("./examples/MixedHeatedConvection/Results/Mixed_Heated_Iterations",P.Ra,
            "_",NC.x,"_",NC.y,
            "_",Ini.T,".png"))
    savefig(p2,string("./examples/MixedHeatedConvection/Results/Mixed_Heated_Final_Stage",P.Ra,
...
plot!(q2,Time[1:find],meanV[1:find],
            ...
            layout=(2,1),subplot=2)
if save_fig == 1
    savefig(q2,string(".//examples/MixedHeatedConvection/Results/Mixed_Heated_TimeSeries",P.Ra,
...
if save_fig == 1
    savefig(q3,string("./examples/MixedHeatedConvection/Results/Mixed_Heated_Profiles",P.Ra,
                        "_",NC.x,"_",NC.y,"_",Ini.T,"_",".png"))
elseif save_fig == 0 
    display(q3)
end
